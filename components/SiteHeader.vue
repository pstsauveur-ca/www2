      ...
      <div class="container flex-lg-row flex-nowrap align-items-center">
        ...
        <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
          <div class="offcanvas-header d-lg-none">
            <h3 class="text-white fs-30 mb-0 display-1">Paroisse<br>Saint-Sauveur</h3>
          ...
          <div class="offcanvas-body ms-lg-auto d-flex flex-column h-100">
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Cimetière</a>
                <ul class="dropdown-menu">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <!-- <li class="nav-item"><a class="nav-link" href="/demarche">Démarche</a></li> -->
                  <!-- <li class="nav-item"><a class="nav-link" href="/alpha">Alpha</a></li> -->
                  <li class="nav-item"><a class="nav-link" href="/implication">S'impliquer</a></li>
                </ul>
              </li>
              <li class="nav-item">
            ...
            <div class="offcanvas-footer d-lg-none">
              <div>
                <a href="mailto:info@pstsauveur.ca" class="link-inverse">info@pstsauveur.ca</a>
                <br />
                (450) 227-2423
                <br />
        ...
        <!-- /.navbar-collapse -->
        <div class="navbar-other @@classList">
